...
export default function Login() {
  ...
  return (
    ...
    <form className="mx-auto w-full text-center lg:w-3/5 p-10"  onSubmit={formik.handleSubmit}>
      ...
      <p className='font-semibold dark:text-gray-300'>or</p>
      <p className='font-semibold dark:text-gray-300 text-sm'>Forgot Password?<Link to="/auth/forgotPassword" className='text-[--main-color] ml-2 underline' >Reset Password</Link> </p>
    </form>
    </>
  )
}
